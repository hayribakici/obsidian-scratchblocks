...
### 0.0.21: Local settings

Allow note-level rendering configuration (see issue #16)

### 0.0.22: PDF export support

Fix PDF export so scratchblocks render correctly.

### 0.0.23: Inline export context menu
